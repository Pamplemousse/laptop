...
read -r -p "What is your GitHub personal access token?" personal_access_token
...
curl -u "Pamplemousse:$personal_access_token" -X POST --data "$post_data" https://api.github.com/user/keys
